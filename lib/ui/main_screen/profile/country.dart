class Countries {
  ...
  static CountryCode? getCountryCodeAndPhone(String phoneWithDialCode) {
    ...
    if (foundedCountry.isNotEmpty) {
      ...
      var splitPhone = phoneWithDialCode.substring(
        foundedCountry["dial_code"]!.length,
      );
...
class CountryCode {
  ...
  final String splitPhone;
  final String code;

  CountryCode(
      {required this.dialCode, required this.splitPhone, required this.code});
}
