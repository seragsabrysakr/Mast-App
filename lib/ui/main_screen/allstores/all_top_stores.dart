...
class AllTopScreen extends StatefulWidget {
  const AllTopScreen({super.key});

  @override
  State<AllTopScreen> createState() => _AllTopScreenState();
}

class _AllTopScreenState extends State<AllTopScreen> {
  late final cubit = getIt<TopStoresCubit>();
  ...
  void initState() {
    ...
    _pagingController.addPageRequestListener((pageKey) {
      cubit.getTopStores(request: request, pageKey: pageKey);
    });
  }
  ...
  getAllRequestBuilder() {
    return BlocListener<TopStoresCubit, FlowState>(
      listener: (context, state) {
        var cubit = TopStoresCubit.get(context);
